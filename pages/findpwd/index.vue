...
export default {
  ...
  mounted () {
    ...
    setTimeout(function () {
      that.someList = [
        {
          html: '<img src="http://placehold.it/100x100" alt="01">'
        },
        {
          html: '<img src="http://placehold.it/150x150" alt="02">'
        },
        {
          html: '<img src="http://placehold.it/200x200" alt="03">'
        },
        {
          html: '<img src="http://placehold.it/250x250" alt="04">'
        },
        {
          html: '<img src="http://placehold.it/300x300" alt="05">'
        },
        {
         html: '<img src="http://placehold.it/350x350" alt="06">' 
        }
      ]
    }, 2000)
  },
